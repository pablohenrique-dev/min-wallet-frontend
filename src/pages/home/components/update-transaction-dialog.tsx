...
export function UpdateTransactionDialog({
  ...
  function onSubmit(values: transactionFormType) {
    mutate({ ...values, id: transaction.id });
    form.reset();
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Adicione novos valores para atualizar a transação!
            </DialogDescription>
          </DialogHeader>
          ...
          <Form {...form}>
            ...
            >
              ...
              <DialogTrigger asChild>
                <Button
                  className="w-full py-6 text-base hover:bg-red-500 hover:text-white"
                  variant="outline"
                  type="button"
                  onClick={() => {
                    ...
                    if (isDeleteConfirmed) deleteTransaction(transaction.id);
                  }}
                >
                  Excluir
                </Button>
